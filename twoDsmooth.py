...
# Could have used Gaussian Kernels to do the same
# but it seemed better visual effects were given when this
# algorithm was followed ( Again, based on original CASA495)
